...
export default function CharacterStage({ statusLine }) {
  ...
  return (
    <div className="glass" style={{ padding: "var(--sp-4)", textAlign: "center" }}>
      <div id="live2d-stage" data-state={state} style={{ height: 260, borderRadius: "var(--radius-xs)", display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(255,255,255,0.03)", border: "1px dashed var(--glass-edge)", color: "var(--text-3)", fontSize: 13, flexDirection: "column", gap: "var(--sp-2)" }}>
